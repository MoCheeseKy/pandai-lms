...
export default function QuizPage() {
  ...
  // --- Components ---
  const StatusBar = () => (
    <div className='flex justify-between items-center px-6 py-3 text-xs font-bold text-gray-900 bg-white select-none z-10'>
      <span>09:22</span>
          ...
          <div className='w-full max-w-[400px] bg-white h-screen sm:h-[844px] sm:rounded-[3rem] overflow-hidden flex flex-col relative shadow-2xl'>
            ...
            <div className='flex items-center gap-2 px-4 py-2'>
              ...
              <h1 className='text-lg font-bold text-[#0f172a] truncate'>
                Tugas {activeCourse.title} Wajib
              </h1>
            </div>
            <div className='flex-1 overflow-y-auto no-scrollbar pb-28 px-6 pt-4'>
              <div className='flex justify-center mb-8 mt-6'>
                <img
                  src='https://cdn3d.iconscout.com/3d/premium/thumb/math-book-and-pencil-3d-icon-download-in-png-blend-fbx-gltf-file-formats--mathematics-education-pack-school-icons-4943144.png'
            ...
            <div className='absolute bottom-0 w-full p-6 bg-white/90 backdrop-blur-sm border-t border-gray-50 pb-8'>
              <button
      ...
      <div className='min-h-screen bg-[#1c1c1e] flex justify-center items-center font-sans'>
        <div className='w-full max-w-[400px] bg-white h-screen sm:h-[844px] sm:rounded-[3rem] overflow-hidden flex flex-col relative shadow-2xl'>
          ...
          <div className='flex items-center gap-2 px-4 py-2 mb-2'>
            ...
            <h1 className='text-lg font-bold text-[#0f172a] truncate'>
              Latihan {activeChapter.chapterTitle.split(': ')[1] || 'Fungsi'}
            </h1>
          </div>
